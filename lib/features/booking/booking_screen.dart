...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Future<void> _loadUserProfile() async {
    final activeProfile = await _authRepository.loadActiveProfile();
    setState(() {
      userName = activeProfile?['name'] ?? 'Unknown Customer';
      userEmail = activeProfile?['email'] ?? 'unknown@example.com';
    });
  }
  ...
  Future<void> _confirmBooking() async {
    ...
    try {
      await _bookingRepository.addBooking(widget.workerName, bookingData);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('✅ Booking confirmed for ${widget.workerName} on $selectedDateTimeString'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Your name: ${userName ?? 'Loading...'}',
            ...
            ElevatedButton(onPressed: _pickTime, child: const Text('Select Time')),
